...
public class MetroStations {
	/*
	 * Код має наступну структуру
	 * 1. Введення початкової станції від якої будемо рухатися,після чтого йде одразу пошук цієї станції у масиві
	 * 2.Введення кінцевої станції і так само одразу пошук станції у масиві
	 * 3.Обрахунки довжини між станціями,та передача довжини між станціями,масиви з цими станціями у метод з шаблонами відповідей.
	 */
